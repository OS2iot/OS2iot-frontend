...
export class DeleteDialogService {
  ...
  showApplicationDialog(application: Application): Observable<any> {
    ...
    const hasSigfoxDevices: boolean = this.applicationHasSigFoxDevices(application);

    if (hasSigfoxDevices) {
      message = this.translate.instant("APPLICATION.DELETE-HAS-SIGFOX-DEVICES-PROMPT");
      showAccept = false;
