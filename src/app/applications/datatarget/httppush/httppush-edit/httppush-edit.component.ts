...
export class HttppushEditComponent  implements OnInit, OnDestroy {
  ...
  private defaultOpenDataDKStatusForNewEntry = false;
  ...
  ngOnInit() {
    ...
    this.defaultOpenDataDKStatusForNewEntry = (datatargetTypeParam == DataTargetType.OPENDATADK)

    this.datatarget.setToOpendataDk = this.defaultOpenDataDKStatusForNewEntry;
