...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import("./payload-decoder/payload-decoder.module").then(m => m.PayloadDecoderModule),
    canActivate: [AuthGuard],
  },
  {
    path: "sigfox",
    loadChildren: () => import("./sigfox/sigfox.module").then(m => m.SigfoxModule),
    canActivate: [AuthGuard],
  },
  {
    path: "device-model",
