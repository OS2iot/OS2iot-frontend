...
export const addServiceProfile = createAction(
    '[ServiceProfile] Add ServiceProfile',
    props<{
...
export const updateServiceProfile = createAction(
    '[ServiceProfile] Update ServiceProfile',
    props<{
        index: number,
        serviceProfile: ServiceProfile
    }>()
...
export const deleteServiceProfile = createAction(
    '[ServiceProfile] Delete ServiceProfile',
    props<{
        index: number
    }>()
);
...
export const setServiceProfiles = createAction(
    '[ServiceProfile] Set ServiceProfiles',
    props<{
...
export const fetchServiceProfiles = createAction(
    '[ServiceProfile] Fetch ServiceProfiles'
);


export const storeServiceProfiles = createAction(
    '[ServiceProfile] Store ServiceProfiles'
);
