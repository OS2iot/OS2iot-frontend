...
export class AwaitingUsersTableComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        this.translate.get(["USERS.DIALOG.QUESTION-REJECT", "USERS.DIALOG.HEAD-REJECT"]).subscribe(translations => {
        ...
        this.deleteDialogService
            ...
            .subscribe(response => {
                if (response) {
                    ...
                    this.userService.rejectUser(rejectUserOrgDto).subscribe(response => {
                        if (response) {
