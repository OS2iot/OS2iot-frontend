...
export class DeviceModelListComponent implements OnInit {
  ...
  constructor(private translate: TranslateService, private titleService: Title, private meService: MeService) {
    translate.use("da");
  }

  ngOnInit(): void {
    this.translate.get(["TITLE.DEVICEMODEL"]).subscribe(translations => {
